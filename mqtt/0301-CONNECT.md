...
> **非规范评注**
>
> 清理会话标志设定为0时，表示当客户端异常断开连接时,服务端必须要将客户端订阅的主题记录下来，当客户端在离线期间，如果有QoS 1或QoS 2级别的消息发布这个主题时，服务器时必须将这些消息存储下来。等到客户端再次上线时，客户端能接收离线期间没有接收到的消息。清理会话标志设定为1时,表示当客户端在离线时，服务时要清除客户端在服务器上的所有状态，当客户端再次上线时，需要重新订阅它需要的主题。
